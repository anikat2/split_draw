...
function Round1Screen({ gameState, sendWs }) {
  ...
  return (
    <div style={styles.gamePage}>
      ...
      <p style={styles.instruction}>draw an image that aligns with the prompt, your partner will complete it</p>
...
function Round2Screen({ gameState, sendWs }) {
  ...
  return (
    <div style={styles.gamePage}>
      ...
      <p style={styles.instruction}>your partner drew some, you complete it · AI is also completing it simultaneously</p>
      <div style={styles.canvasWrapper}>
        <canvas ref={canvasRef} width={600} height={400} style={styles.canvas}
          onMouseDown={startDraw} onMouseMove={draw} onMouseUp={stopDraw} onMouseLeave={stopDraw}
          onTouchStart={startDraw} onTouchMove={draw} onTouchEnd={stopDraw} />
...
function Round3Screen({ gameState, sendWs }) {
  ...
  const handleAutoVote = useCallback(() => {
    if (voted) return;
    // auto-pick randomly if time runs out without voting
